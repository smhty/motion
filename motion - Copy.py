...
def type_1(j, a, v, d, v_0 = 0):
	...
	"""
	data = []
	for t, jerk  in [[t_1, j_m], [t_2, 0], [t_1, -j_m], [t_4, 0], [t_1,-j_m], [t_2, 0], [t_1, j_m]]:
		if t > 0:
			data.append({"tick": t, "jerk": jerk})
	"""
	return [[[t_1, j_m], [t_2, 0], [t_1, -j_m], [t_4, 0], [t_1,-j_m], [t_2, 0], [t_1, j_m]] , a_m, v_m, d_m]
...
def type_2(j, a, v, d, v_0 = 0):
	...
	#return [j_m, a_m, v_m , t_1, t_2, t_4]
	return [[[t_1, j_m], [t_2, 0], [t_1, -j_m], [t_4, 0]], a_m, v_m, d_m]
...
def type_3(j, a, v_0, d):
	...
	# return [j_m, a_m, d_m , t_1, t_2, t_4]
	return [[[t_4, 0], [t_1, -j_m], [t_2, 0], [t_1, j_m]], a_m, v_m, d_m]


def type_3_copy(j, a, v_0, d = 0, fit = True):
	
	t_1_a = math.floor(a / j)
	t_1_v = math.floor((v_0/j)**(1/2))
	t_1_d = math.floor((d/v)-1)
